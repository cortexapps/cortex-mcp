...
def customize_components(
    ...
    if isinstance(component, OpenAPITool):
        ...
        #
        # This code strips $defs from MCP tool schemas generated by OpenAPI docs.
        # However, input schemas containing nested $ref references then fail to resolve,
        # resulting in "PointerToNowhere" errors.
        # Use openapi_resolver script to replace ALL $ref with inline schema definitions,
        # and eliminate the need for $defs entirely.
        # 
